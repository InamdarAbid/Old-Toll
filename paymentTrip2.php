        ...
        <div class="container">
			...
			<div class="con">
				...
				<div  id="text">
					...
					<form action="payment_ctrl2.php" method="post" id="f1">
						<fieldset>					
						...
						<label class="labelip">Select Road for journey * :</label>
						<select class="cen1" name="road">
							<option value="Highway 50">Highway 50</option>
							<option value="Highway 48">Highway 48/</option>	
						</select>					
						<br>
						<label class="labelip">Amount* :</label>
						<label for="amount" class = "amount" >300</label><br>
						<input type="hidden" value="300" name="amount">
						<a href="paymentTrip1.php"><input type="button" class="trip" id="notact" value="One-way" ></a>
						<a href="#"><input type="button" class="trip" id="active2" value="Round Trip"></a>
						<br><br>
						<div class="prevnext">
						<a href="payment.php"><input type="button" id="prev" value="Prev" ></a>
						<input type='submit' id="b1"  value="Next" >
						</div>
						</fieldset>
					</form>					
